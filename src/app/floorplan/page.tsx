...
export default function FloorPlanPage() {
    ...
    // Current month for invoice lookup
    const currentMonth = currentMonthBangkok();
    ...
    useEffect(() => {
        Promise.all([
            ...
            fetch(`/api/billing?month=${currentMonth}`).then(r => r.json()),
        ]).then(([roomsData, bathroomsData, tenantsData, posData, invoiceData]) => {
